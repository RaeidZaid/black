...
# ==========================================
# 1. دوال حفظ وتحميل ستايلات الأزرار
# ==========================================
...
# ==========================================
# 2. الحقن الديناميكي (Monkey Patching) للأزرار
# هذا الجزء يقوم بتلوين وإضافة الرموز لأزرارك القديمة
# والجديدة تلقائياً دون الحاجة لتعديل أي كليشة ازرار!
# ==========================================
...
def custom_kb_init(self, text, *args, **kwargs):
    ...
    if text in styles:
        if 'style' in styles[text]:
            self.style = styles[text]['style']
        if 'icon_custom_emoji_id' in styles[text]:
            self.icon_custom_emoji_id = styles[text]['icon_custom_emoji_id']
